...
let caracteresRestantes = document.querySelector("#numero-caracteres");


inputDescripcion.addEventListener("input", (e) => {
  caracteresRestantes.innerText = inputDescripcion.value.length;
});
...
botonLimpiar.addEventListener("click", (e) => {
  listaProductos.classList.add("animate__animated", "animate__bounceOut");
  setTimeout(() => {
  listaProductos.innerHTML = "";
  listaProductos.classList.remove("animate__animated", "animate__bounceOut");
  }, 700);
});
